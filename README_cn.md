...
体验网址： [AI Chat Free](https://www.geminiprochat.com)
...
> 3. 在你的 **AI Chat Free** 项目中，设置名为 `API_BASE_URL` 的环境变量，其值为部署 palm-proxy 时获得的域名 (`https://xxx.netlify.app`)。
> 4. 重新部署你的 **AI Chat Free** 项目来完成配置。这应该可以解决问题。
>
...
| `API_BASE_URL` | Gemini API 的自定义基本 URL。点击[此处](https://github.com/ievjai/aichatfree/README_cn.md#solution-for-user-location-is-not-supported-for-the-api-use)查看何时使用这个。| ❌ |
